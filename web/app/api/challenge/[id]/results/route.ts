...
// otherwise the client's anonymous uid. Only the creator (whose uid matches the write-once creator
// uid) gets data; everyone else gets 403. The creator's uid never appears on the public board, so
// matching it is as strong as identity gets in the anonymous model.
