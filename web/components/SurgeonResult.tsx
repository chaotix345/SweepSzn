    ...
    <div className="animate-rise-in mt-4 overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-900">
      ...
      <div className="border-t border-zinc-800 px-6 py-4">
        <div className="flex gap-3">
          ...
          {shared ? (
            <Link href="/play?mode=daily" className="flex-1 rounded-xl bg-orange-500 py-2.5 text-center text-sm font-bold text-black hover:bg-orange-400">Fix your own five →</Link>
          ) : (
